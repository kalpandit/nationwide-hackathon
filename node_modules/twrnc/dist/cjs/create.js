...
const ClassParser_1 = __importDefault(require("./ClassParser"));
...
function create(customConfig, platform) {
    ...
    function getCache() {
        ...
        const cache = new cache_1.default(customStyleUtils);
    ...
    function style(...inputs) {
        ...
        for (const utility of utilities) {
            ...
            if (!styleIr && utility in customStringUtils) {
                ...
                cache.setIr(utility, (0, helpers_1.complete)(customStyle));
                resolved = { ...resolved, ...customStyle };
                continue;
            }
            const parser = new ClassParser_1.default(utility, config, cache, device, platform);
    ...
    tailwindFn.prefixMatch = (...prefixes) => {
        ...
        const parser = new ClassParser_1.default(`${joined}:flex`, config, cache, device, platform);
